...
public class TrafoTest extends Application {
    ...
    TrafoTest(int ball_number, int model, int evolution_value)
    {
    ...
    {
        // moveBall function is the core function of the program. It defines how to move every ball, whether it is a Monte Carlo Method,
        // or whether it is a pure geometric force field method.
        // for(int i = 0; i < lines_cylinder.length; i++)
        // {
        //     root.getChildren().remove(lines_cylinder[i]);
        // }

        // int account is used to record the number of the lines
        int account;
        ...
        // root.getChildren().removeAll(lines_cylinder);
    ...
    {
        // draw_line function is actually change the color of cylinders based on the force between two balls
        // once the force is repulsive, the color is red,
        // once the force is attractive, the color is yellow;
        // this.lines_cylinder = new Cylinder[this.ball_number * (this.ball_number - 1) / 2];
        int count = 0;
        for(int i  = 0; i < ball_number - 1; i++)
        {
    ...
    private void buildBodySystem() {
        // buildBodySystem is used to build the box, in which every ball could only be restriced
        // to move.
