...
public class Scatter_Point extends Application {
    ...
    public void start(Stage primarystage)
    {
        ...
        if (this.model != -1)
        {
            ...
            double delta = double_max(y_list) - double_min(y_list);
            y_axis = new NumberAxis(-delta / 10 + double_min(y_list), delta / 10 + double_max(y_list), (double_max(y_list) - double_min(y_list) + 20) / 10.0);
            y_axis.setLabel("Energy");
        ...
        function.setTranslateX(0);
        function.setTranslateY(-100);
